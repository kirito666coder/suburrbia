...
import { LazyYouTubePlayer } from "../ProductGrid/LazyYoutubePlayer";
  ...
  return (
    ...
    >
      ...
      <div className="relative aspect-video">
        <div className={clsx( MASK_CLASSES,
          'bg-brand-lime absolute inset-0 translate-x-2 md:translate-x-3 translate-y-2 md:translate-y-3'
        )}>
        <div className={clsx( MASK_CLASSES,
          'bg-white absolute inset-0 translate-x-1 md:translate-x-3 translate-y-1 md:translate-y-2'
        )}>
        <div className={clsx( MASK_CLASSES,
          'bg-white absolute inset-0 translate-x-1 md:translate-x-2 -translate-y-1 md:-translate-y-3'
        )}>
